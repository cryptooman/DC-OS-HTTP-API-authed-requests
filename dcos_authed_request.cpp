/*
    Tool for making authorized REST API requests to DC/OS
    ...
    Usage:
        ...
        dcos_authed_request '{"method":"GET","url":"http://<master-addr>/service/chronos/v1/scheduler/jobs/summary","post":""}' | jq
...
const string HW_SYSTEM_ID_ENC = R"(?8OL;?7G#;O7=#:P?>#66>K#7R:9>L6M6J>6)";
const string AUTH_TOKEN_ENC   = R"(kwD>kVOgAgEGX?_gBLDflImgAgUG[tG?@gD7 kwDbkFOgAdK:CJ[=CtevCJ_}G`X~TMG5Gc@wkVL>l<7zWY;OT<?foYy{W<7zG`> <OBm7bHDW6G|g|i_>w}<@bW[CGkkt:|xtVOXG>@tbxG)";
